    ...
    <div class="container-fluid">
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			...
			<a class="nav-link active" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="true" style="background-color: white; border: 2px solid blue; padding: 5px; text-align: center; color: black; font-weight: bold;">Add Item</a>
			<a class="nav-link" id="v-pills-purchase-tab" data-toggle="pill" href="#v-pills-purchase" role="tab" aria-controls="v-pills-purchase" aria-selected="false" style="background-color: white; border: 2px solid blue; padding: 5px; text-align: center; color: black; font-weight: bold;">Purchase Stock</a>
			<a class="nav-link" id="v-pills-vendor-tab" data-toggle="pill" href="#v-pills-vendor" role="tab" aria-controls="v-pills-vendor" aria-selected="false" style="background-color: white; border: 2px solid blue; padding: 5px; text-align: center; color: black; font-weight: bold;">Vendor</a>
			<a class="nav-link" id="v-pills-sale-tab" data-toggle="pill" href="#v-pills-sale" role="tab" aria-controls="v-pills-sale" aria-selected="false" style="background-color: white; border: 2px solid blue; padding: 5px; text-align: center; color: black; font-weight: bold;">Sale</a>
			<a class="nav-link" id="v-pills-customer-tab" data-toggle="pill" href="#v-pills-customer" role="tab" aria-controls="v-pills-customer" aria-selected="false" style="background-color: white; border: 2px solid blue; padding: 5px; text-align: center; color: black; font-weight: bold;">Customer</a>
			<a class="nav-link" id="v-pills-reports-tab" data-toggle="pill" href="#v-pills-reports" role="tab" aria-controls="v-pills-reports" aria-selected="false" style="background-color: white; border: 2px solid blue; padding: 5px; text-align: center; color: black; font-weight: bold;">Reports</a>
			</div>
		</div>
		 <div class="col-lg-10">
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="vendorDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-row">
						<div class="form-group col-md-6">
						  <label for="vendorDetailsVendorCity">Postal Code</label>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="customerDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-row">
						  <div class="form-group col-md-3">
							<label for="customerDetailsCustomerMobile">Mobile Phone<span class="requiredIcon">*</span></label>
